...
public class RobotContainer {
    ...
    //  private final CvSource outputStream = new CvSource("Blur", VideoMode.PixelFormat.kMJPEG,
    // 640, 480, 30);
    ...
    private void configureButtonBindings() {
        ...
        // aim & shoot command
        // lBumper.whenPressed(new VisionShootToggleCommand(m_swerveDrive, m_vision, m_shooter,
        // m_magazine, true));
        ...
        // aButton.whenPressed(new VisionShootToggleCommand(m_swerveDrive, m_vision, m_shooter,
        // m_magazine, false));
        // manual high
        yButton.whenPressed(
