...
public class SwerveDrive extends SubsystemBase {
    ...
    public void pidTune() {
        ...
        //    SmartDashboard.putNumber("rR", m_rearRight.m_driveMotor.getSelectedSensorVelocity() /
        // setpoint);
        //    SmartDashboard.putNumber("rL", m_rearLeft.m_driveMotor.getSelectedSensorVelocity() /
        // setpoint);
        //    SmartDashboard.putNumber("fR", m_frontRight.m_driveMotor.getSelectedSensorVelocity() /
        // setpoint);
        //    SmartDashboard.putNumber("fL", m_frontLeft.m_driveMotor.getSelectedSensorVelocity() /
        // setpoint);
